...
def main():
    products = [
        ...
        {"name": "BadStuff", "price": -5, "discount_rate": 0.05},
        {"name": "MoreBadStuff", "price": "abc", "discount_rate": 0.05}
    ]
    ...
    for product in products:
        ...
        if (isinstance(price, (int, float))):
            if (price > 0):
                ...
                print(f"Error in database product: {product['name']} has a negative price")
        else:
            print(f"Error in database product: {product['name']} does not have valid price")
            print()
